...
export declare class Bus<T extends Record<string, any> = any, H extends Record<string, (data: any) => any> = any> {
    id: string;
    private _adapter;
    ...
    request<E extends keyof H>(name: E, data?: Parameters<H[E]>[0], timeout?: number): Promise<ReturnType<H[E]> extends Promise<infer P> ? P : ReturnType<H[E]>>;
    ...
    registerRequestHandler<E extends keyof H>(name: E, handler: H[E]): this;
    unregisterHandler<E extends keyof H>(name: E): this;
    ...
    private static _isPromise;
    private static _dataToMessage;
    private static _messageToData;
}
