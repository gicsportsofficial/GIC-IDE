...
},{"..":5,"../protocols/WindowProtocol":6,"../utils/utils":10,"./Adapter":1}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Bus = /** @class */ (function () {
    ...
    Bus._dataToMessage = function (data) {
        var type = data instanceof Error ? 'error' : 'data';
        var content = type === 'error'
            ? data.message
            : data;
        return { type: type, content: content };
    };
    Bus._messageToData = function (message) {
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(require("./bus/Bus"));
__export(require("./adapters/Adapter"));
__export(require("./adapters/WindowAdapter"));
__export(require("./protocols/WindowProtocol"));
__export(require("./config"));
__export(require("./utils"));

},{"./adapters/Adapter":1,"./adapters/WindowAdapter":2,"./bus/Bus":3,"./config":4,"./protocols/WindowProtocol":6,"./utils":9}],6:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"typed-ts-events":12}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../../config":4,"../utils":10}],9:[function(require,module,exports){
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
...
__export(require("./UniqPrimitiveCollection"));

},{"./UniqPrimitiveCollection":7,"./console":8,"./utils":10}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function keys(o) {
