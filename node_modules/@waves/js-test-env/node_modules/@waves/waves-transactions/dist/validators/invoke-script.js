...
exports.invokeV3Validator = exports.invokeValidator = void 0;
...
const invokeV3Scheme = Object.assign(Object.assign({}, invokeScheme), { extraFeePerStep: validators_1.isNumberLike });
exports.invokeValidator = validators_1.validateByShema(invokeScheme, validators_1.getError);
exports.invokeV3Validator = validators_1.validateByShema(invokeV3Scheme, validators_1.getError);
