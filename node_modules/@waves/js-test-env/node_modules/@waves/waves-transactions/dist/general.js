...
function submitOrder(ord, opts) {
    ...
    return request_1.default({ base: matcherUrl, url: endpoint, options: { method: 'POST', body: stringify_1.default(ord), headers: { 'Content-Type': 'application/json' } } });
}
...
function cancelSubmittedOrder(co, amountAsset, priceAsset, matcherUrl) {
    ...
    return request_1.default({ base: matcherUrl, url: endpoint, options: { method: 'POST', body: stringify_1.default(co), headers: { 'Content-Type': 'application/json' } } });
}
