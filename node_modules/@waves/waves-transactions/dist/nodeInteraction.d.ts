...
declare type PropApplicationStatus = {
    applicationStatus?: 'succeeded' | 'script_execution_failed';
};
declare type TxStatus = Transaction & PropApplicationStatus;
/**
 * Resolves when specified txId is mined into block
 * @param txId - waves address as base58 string
 * @param options
 */
export declare function waitForTx(txId: string, options: INodeRequestOptions, requestOptions?: RequestInit): Promise<TxStatus>;
export declare function waitForTxWithNConfirmations(txId: string, confirmations: number, options: INodeRequestOptions, requestOptions?: RequestInit): Promise<TxStatus>;
 ...
 */
export declare function transactionById(txId: string, nodeUrl: string, requestOptions?: RequestInit): Promise<Transaction & WithId & {
    height: number;
}>;
/**
 * Get account effective balance
 ...
 * @param nodeUrl - node address to ask balance from. E.g. https://nodes.wavesplatform.com/
 */
export declare function assetBalance(assetId: string, address: string, nodeUrl: string, requestOptions?: RequestInit): Promise<string | number>;
 ...
 */
export declare function accountData(options: IAccountDataRequestOptions, nodeUrl: string, requestOptions?: RequestInit): Promise<Record<string, DataTransactionEntry>>;
export declare function accountData(address: string, nodeUrl: string, requestOptions?: RequestInit): Promise<Record<string, DataTransactionEntry>>;
/**
 ...
 * @param nodeUrl - node address to ask data from. E.g. https://nodes.wavesplatform.com/
 */
export declare function accountDataByKey(key: string, address: string, nodeUrl: string, requestOptions?: RequestInit): Promise<DataTransactionEntry<TLong> | null>;
/**
 ...
 */
export declare function broadcast<T extends SignedTransaction<Transaction<TLong>>>(tx: T, nodeUrl: string, requestOptions?: RequestInit): Promise<T & WithApiMixin>;
export {};
