...
export declare type TTxParams<LONG = string | number> = IAliasParams<LONG> | IBurnParams<LONG> | IInvokeScriptParams<LONG> | ICancelLeaseParams<LONG> | IDataParams<LONG> | IIssueParams<LONG> | ILeaseParams<LONG> | IMassTransferParams<LONG> | IReissueParams<LONG> | ISetAssetScriptParams<LONG> | ISetScriptParams<LONG> | ISponsorshipParams<LONG> | ITransferParams<LONG> | IUpdateAssetInfoParams<LONG> | IInvokeExpressionParams<LONG>;
/**
...
export declare type TTransaction = Exclude<Transaction, GenesisTransaction | PaymentTransaction>;
export declare type TTransactionType = Exclude<typeof TRANSACTION_TYPE[keyof typeof TRANSACTION_TYPE], 1 | 2>;
export declare type WithChainId = {
    chainId: number;
};
export declare type TTx = SignedTransaction<TTransaction>;
