...
export declare type PaymentTransactionFromNode<LONG = Long> = SignedTransaction<PaymentTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
export declare type IssueTransaction<LONG = Long> = IssueTransactionV1<LONG> | IssueTransactionV2<LONG> | IssueTransactionV3<LONG>;
export declare type IssueTransactionFromNode<LONG = Long> = SignedTransaction<IssueTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
    assetId: string;
};
...
export declare type TransferTransactionFromNode<LONG = Long> = SignedTransaction<TransferTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin;
export declare type LeaseTransaction<LONG = Long> = LeaseTransactionV1<LONG> | LeaseTransactionV2<LONG> | LeaseTransactionV3<LONG>;
export declare type LeaseTransactionFromNode<LONG = Long> = SignedTransaction<LeaseTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
    status: 'canceled' | 'active';
};
export declare type BurnTransaction<LONG = Long> = BurnTransactionV1<LONG> | BurnTransactionV2<LONG> | BurnTransactionV3<LONG>;
export declare type BurnTransactionFromNode<LONG = Long> = SignedTransaction<BurnTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
...
export declare type ReissueTransactionFromNode<LONG = Long> = SignedTransaction<ReissueTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
...
export declare type CancelLeaseTransactionFromNode<LONG = Long> = SignedTransaction<CancelLeaseTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
} & {
    lease: {
        id: string;
...
export declare type AliasTransactionFromNode<LONG = Long> = SignedTransaction<AliasTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
export declare type MassTransferTransaction<LONG = Long> = MassTransferTransactionV1<LONG> | MassTransferTransactionV2<LONG>;
export declare type MassTransferTransactionFromNode<LONG = Long> = SignedTransaction<MassTransferTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
    totalAmount: LONG;
    transferCount: number;
};
export declare type DataTransaction<LONG = Long> = DataTransactionV1<LONG> | DataTransactionV2<LONG>;
export declare type DataTransactionFromNode<LONG = Long> = SignedTransaction<DataTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
export declare type SetScriptTransaction<LONG = Long> = SetScriptTransactionV1<LONG> | SetScriptTransactionV2<LONG>;
export declare type SetScriptTransactionFromNode<LONG = Long> = SignedTransaction<SetScriptTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
export declare type SponsorshipTransaction<LONG = Long> = SponsorshipTransactionV1<LONG> | SponsorshipTransactionV2<LONG>;
export declare type SponsorshipTransactionFromNode<LONG = Long> = SignedTransaction<SponsorshipTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
...
export declare type ExchangeTransactionFromNode<LONG = Long> = SignedTransaction<ExchangeTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
...
export declare type SetAssetScriptTransactionFromNode<LONG = Long> = SignedTransaction<SetAssetScriptTransaction<LONG>> & WithId & WithApplicationStatus & WithApiMixin & {
    feeAssetId: null;
};
...
export declare type EthereumTransaction<LONG = Long> = EthereumTransactionV1<LONG> & WithApiMixin & WithApplicationStatus & {
    feeAssetId: null;
};
