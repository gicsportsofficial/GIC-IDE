...
export declare function fetchDataKey(base: string, address: string, key: string, options?: RequestInit): Promise<TDataTransactionEntry<TLong>>;
export declare function fetchScriptInfoMeta(base: string, address: string, options?: RequestInit): Promise<IScriptInfoMetaResponse>;
...
export declare function data(base: string, address: string, params?: IDataQueryParams, options?: RequestInit): Promise<Array<TDataTransactionEntry<TLong>>>;
export declare function fetchValidate(base: string, address: string, options?: RequestInit): Promise<IValidateResponse>;
...
export declare function fetchSeq(base: string, from: number, to: number, options?: RequestInit): Promise<Array<string>>;
export declare function fetchSeed(base: string, address: string, options?: RequestInit): Promise<string>;
export declare function fetchPublicKey(base: string, publicKey: string, options?: RequestInit): Promise<IPublicKeyResponse>;
export declare function fetchAddresses(base: string, options?: RequestInit): Promise<Array<string>>;
