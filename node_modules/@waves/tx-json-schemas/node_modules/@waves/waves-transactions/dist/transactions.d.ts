...
export declare type TDataEntry = TTypedData & {
    key: string;
};
export declare type TTypedData = IBooleanData | IIntegerData | IStringData | IBinaryData;
export declare type TDeleteRequest = {
    type?: null;
    value?: null;
    key: string;
};
...
export declare type TDataFiledType = typeof DATA_FIELD_TYPE[keyof typeof DATA_FIELD_TYPE];
...
export declare type TInvokeScriptCallArgument<LONG = string | number> = IInvokeScriptCallStringArgument | IInvokeScriptCallBinaryArgument | IInvokeScriptCallBoolArgument | IInvokeScriptCallIntegerArgument<LONG> | IInvokeScriptCallListArgument<LONG>;
/**
 * @typeparam LONG Generic type representing LONG type. Default to string | number. Since javascript number more than 2 ** 53 -1 cannot be precisely represented, generic type is used
 */
