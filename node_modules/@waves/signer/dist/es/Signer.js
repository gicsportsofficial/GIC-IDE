...
import { argsValidators, validateSignerOptions, validateProviderInterface, } from './validation';
...
var Signer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!providerValidation.isValid) {
                    error = this._handleError(ERRORS.PROVIDER_INTERFACE, [providerValidation.invalidProperties]);
                    throw error;
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        error = this._handleError(ERRORS.PROVIDER_INTERNAL, err_1.message);
                        throw error;
    ...
    Signer.prototype._sign = function (toSign) {
        ...
        if (validation.isValid) {
            ...
            var error = this._handleError(ERRORS.API_ARGUMENTS, [validation.errors]);
            throw error;
        }
    };
    __decorate([
