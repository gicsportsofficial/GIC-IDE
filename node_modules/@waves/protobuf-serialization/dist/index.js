    ...
    waves.events = (function() {
        ...
        events.TransactionMetadata = (function() {
            ...
            Object.defineProperty(TransactionMetadata.prototype, "metadata", {
                get: $util.oneOfGetter($oneOfFields = ["transfer", "massTransfer", "invokeScript", "leaseMeta"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            TransactionMetadata.encode = function encode(m, w) {
                ...
                if (m.leaseMeta != null && m.hasOwnProperty("leaseMeta"))
                    $root.waves.events.TransactionMetadata.LeaseMetadata.encode(m.leaseMeta, w.uint32(938).fork()).ldelim();
                return w;
            };
            ...
            TransactionMetadata.decode = function decode(r, l) {
                ...
                while (r.pos < c) {
                    ...
                    case 116:
                        ...
                        break;
                    case 117:
                        m.leaseMeta = $root.waves.events.TransactionMetadata.LeaseMetadata.decode(r, r.uint32());
                        break;
                    default:
                        r.skipType(t & 7);
                        break;
                ...
                InvokeScriptMetadata.encode = function encode(m, w) {
                    ...
                    if (m["arguments"] != null && m["arguments"].length) {
                        for (var i = 0; i < m["arguments"].length; ++i)
                            $root.waves.events.TransactionMetadata.InvokeScriptMetadata.Argument.encode(m["arguments"][i], w.uint32(26).fork()).ldelim();
                    }
                    ...
                    while (r.pos < c) {
                        ...
                        case 3:
                            if (!(m["arguments"] && m["arguments"].length))
                                m["arguments"] = [];
                            m["arguments"].push($root.waves.events.TransactionMetadata.InvokeScriptMetadata.Argument.decode(r, r.uint32()));
                            break;
                        case 4:
    ...
    waves.Transaction = (function() {
        ...
        Transaction.encode = function encode(m, w) {
            ...
            if (m.invokeExpression != null && m.hasOwnProperty("invokeExpression"))
                $root.waves.InvokeExpressionTransactionData.encode(m.invokeExpression, w.uint32(946).fork()).ldelim();
            return w;
        };
