...
import { RunOnceScheduler, Delayer, asWinJsPromise } from '../../../base/common/async';
...
import { FoldingProviderRegistry, FoldingRangeType } from '../../common/modes';
...
var FoldingController = /** @class */ (function () {
    function FoldingController(editor) {
        ...
        this.globalToDispose.push(FoldingProviderRegistry.onDidChange(function () { return _this.onFoldingStrategyChanged(); }));
